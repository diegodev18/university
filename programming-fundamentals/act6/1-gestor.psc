Algoritmo GestorAsignacionTareas
    ...
    Para i <- 0 Hasta 2 Con Paso 1 Hacer  // Tarea para E1
        Para j <- 0 Hasta 2 Con Paso 1 Hacer  // Tarea para E2
            Para k <- 0 Hasta 2 Con Paso 1 Hacer  // Tarea para E3
                ...
                Si i <> j Y i <> k Y j <> k Entonces
                    ...
                    combinacion[0] <- i  // E1 -> Ti
                    combinacion[1] <- j  // E2 -> Tj
                    combinacion[2] <- k  // E3 -> Tk
                    
                    // Calcular el tiempo total para esta combinación
                    tiempoTotal <- tiempos[0,i] + tiempos[1,j] + tiempos[2,k]
                    
                    // Mostrar la combinación actual
                    Escribir Sin Saltar "Combinación ", numCombinacion, ": "
                    Escribir Sin Saltar "E1->T", i+1, " (", tiempos[0,i], "h), "
                    Escribir Sin Saltar "E2->T", j+1, " (", tiempos[1,j], "h), "
                    Escribir Sin Saltar "E3->T", k+1, " (", tiempos[2,k], "h)"
                    ...
                    Si tiempoTotal < tiempoMinimo Entonces
                        ...
                        mejorCombinacion[0] <- i
                        mejorCombinacion[1] <- j
                        mejorCombinacion[2] <- k
                    FinSi
                FinSi
            FinPara
        FinPara
    ...
    Escribir "• E1 asignado a T", mejorCombinacion[0]+1, " (", tiempos[0,mejorCombinacion[0]], " horas)"
    Escribir "• E2 asignado a T", mejorCombinacion[1]+1, " (", tiempos[1,mejorCombinacion[1]], " horas)"
    Escribir "• E3 asignado a T", mejorCombinacion[2]+1, " (", tiempos[2,mejorCombinacion[2]], " horas)"
    Escribir ""
